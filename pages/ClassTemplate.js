...
templates['ClassTemplate'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<div class=\"class-container\" data-classname=\""
    ...
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.Notes : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":9,"column":6},"end":{"line":13,"column":15}}})) != null ? stack1 : "")
    + "    </ul>\n\n"
    + ((stack1 = container.invokePartial(partials.AddNoteButtonTemplate,depth0,{"name":"AddNoteButtonTemplate","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "</div>\n";
